 ...
 * 
*/
$config['access_control_allow_origin'] = BASE_URL . ' https://*.tangerangkota.go.id/';
 ...
 *
*/
$config['nel'] = '{"report_to":"default","max_age":31536000,"include_subdomains":true}';

/**
 * Value: Expect-CT: max-age=86400, enforce, report-uri="https://foo.example/report" | false
 * 
*/
$config['expect_ct'] = 'max-age=86400, enforce, report-uri="https://tangerangkota.report-uri.com/r/d/ct/enforce"';

$config['expect_staple'] = '{ "name": "localhost", "include_subdomains": true, "mode": "force-https", "expect_staple": true, "expect_staple_report_uri": "https://tangerangkota.report-uri.io/r/default/staple/reportOnly", "include_subdomains_for_expect_staple": true }';
 ...
 * 
*/
$config['cross_origin_embedder_policy'] = "require-corp; report-to='default'";

/**
 * Cross-Origin-Opener-Policy: unsafe-none | same-origin-allow-popups | same-origin | same-origin; report-to='report_group' | false
 * 
*/
$config['cross_origin_opener_policy'] = "same-origin; report-to='default'";
 ...
 * 
*/
$config['strict_transport_security'] = 'max-age=31536000; includeSubDomains; preload;';